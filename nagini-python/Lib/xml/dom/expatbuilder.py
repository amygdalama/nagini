...
from xml.dom accio xmlbuilder, minidom, Node
from xml.dom accio EMPTY_NAMESPACE, EMPTY_PREFIX, XMLNS_NAMESPACE
from xml.parsers accio expat
from xml.dom.minidom accio _append_child, _set_attribute_node
